...
class SowRequestSerializer(serializers.Serializer):
    ...
    location = serializers.CharField(max_length=100, default="HQ-01", allow_blank=True, allow_null=True)
    currency = serializers.ChoiceField(
        choices=["USD", "INR", "EUR", "GBP", "AUD", "CAD"], default="USD"
    )
    users = serializers.IntegerField(min_value=0, default=0)
    wifi_aps = serializers.IntegerField(min_value=0, default=0)
    iot_devices = serializers.IntegerField(min_value=0, default=0)
    other_devices = serializers.IntegerField(min_value=0, default=0)
    firewalls = serializers.IntegerField(min_value=0, default=0)
    connectivity = serializers.CharField(max_length=100, default="10GB Fiber", allow_blank=True, allow_null=True)
